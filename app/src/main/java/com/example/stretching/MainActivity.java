...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataItem[] dataList = {
                ...
                new DataItem(R.drawable.i2, " 굽은 허리와 다리 교정  1:00"),
                new DataItem(R.drawable.i3, " 굽은 허리 교정  1:30"),
                new DataItem(R.drawable.i4, " 굽은 허리와 다리교정 2  1:00 "),
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // 이미지뷰 크기 조정
                int desiredWidth = 750; // 원하는 가로 크기 (픽셀 단위)
                int desiredHeight = 600; // 원하는 세로 크기 (픽셀 단위)
